...
![Рис.1 Тест сервера в браузере](https://github.com/NEGLEB/Pro/blob/master/Inages_for_lab6/test.jpg?raw=true)
...
![Рис.2 Ответ от сайта](https://github.com/NEGLEB/Pro/blob/master/Inages_for_lab6/postman.jpg?raw=true)
**4\.** Пишем клиен и убеждаемся, что он получает тот же ответ на нашь запрос, что и postman.
![Рис.3 Ответ клиенту](https://github.com/NEGLEB/Pro/blob/master/Inages_for_lab6/klient.jpg?raw=true)
...
![Рис.4 Ответ клиенту](https://github.com/NEGLEB/Pro/blob/master/Inages_for_lab6/itog.jpg?raw=true)
